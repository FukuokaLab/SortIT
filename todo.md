...
- [x] Local
  ...
  - [x] CSV export, project level (`/sortIT/project/<id>/download_csv`): header `Image_ID,filepath,<user...>`, one row per image @done(20260814 22:43)
...
- [x] Docker @done(20260908)
  ...
  - [x] CSV export, project level (`/sortIT/project/<id>/download_csv`): header `Image_ID,filepath,<user...>`, one row per image @done(20260908)
  ...
  - [x] CLI export: `python manage.py export_csv --project <name>` (docker: `docker compose exec web python ...`) → `Image_ID,filepath,<user...>` @done(20260908) 
