...
- [x] make port configurable in docker
...
- [ ] Local
  - [ ] `http://localhost:8000/account/login/` loads with styling (no broken static files)
  - [ ] Visiting `/sortIT/` while logged out redirects to the login page
